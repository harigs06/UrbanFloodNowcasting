"""Clean, complete generator for frontend/src/data/mockData.ts"""

import json
from pathlib import Path

# HYDERABAD (45 Segments)
HYD_STREETS = [
...
# MUMBAI (35 Segments)
MUM_STREETS = [
    ("mum-st-01", "Marine Drive Promenade Outer Lane", "Nariman Point (Ward A)", "NCPA Circle", "Churchgate Flyover", 1900, 7.5, 0.50, 5.5, 8.0, 6.5, False,
...
CHN_STREETS = [
    ...
    ("chn-st-09", "Poonamallee High Road (EVR Periyar)", "Kilpauk (Zone 8)", "Chennai Central Station", "Kilpauk Medical College Jn", 2900, 11.0, 0.75, 7.5, 6.0, 7.2, False,
     [[13.082, 80.275], [13.078, 80.255], [13.075, 80.235]]),
...
KOL_STREETS = [
    ("kol-st-01", "CR Avenue (Central Avenue Lowland Basin)", "Bowbazar (Ward 44)", "Girish Park", "Esplanade Metro Crossing", 2400, 36.5, 2.05, 4.2, 4.0, 13.5, True,
     [[22.595, 88.362], [22.580, 88.360], [22.565, 88.355]]),
...
def format_street_ts(street_tuple):
    ...
    ward: {json.dumps(ward)},
    fromIntersection: {json.dumps(f_int)},
    toIntersection: {json.dumps(t_int)},
    lengthM: {l_m},
    waterDepthCm: {d_cm},
    riskLevel: {json.dumps(risk)},
    flowVelocityMs: {vel},
    coordinates: [
      {coords_str}
    ],
...
print(f"Generated clean mockData.ts with {len(final_ts)} characters!")
